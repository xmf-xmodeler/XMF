 ...
 *             ------------------------------------------------               *
 *                                                                            *
 *  When the VM encounters an error it attempts to poke it through to the     *
 *  upper levels as an instance of MachineException. The type of exception is *
 *  passed upwards via an error code that is one of the codes defined in this *
 *  file.                                                                     *
 *                                                                            *
 ******************************************************************************/
