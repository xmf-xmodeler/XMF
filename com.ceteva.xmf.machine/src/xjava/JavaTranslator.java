...
public class JavaTranslator {
	...
	public static Object mapXMFConsToArray(Machine machine, Class<?> type, int value) {
		...
		/*
		 * if (type == Float.TYPE) return mapXMFConsToFloatArray(machine,
		 * value); if (type == Double.TYPE) return
		 * mapXMFConsToDoubleArray(machine, value);
		 */
	...
	public static Object mapXMFValue(Machine machine, Class<?> type, int value) {
		...
		if (Machine.isString(value))
			if (type == String.class || type == java.lang.Object.class)
				...
				throw new XMFToJavaTypeError("String clash", value, type);
		...
		if (Machine.isForeignObj(value)) {
			...
			if (type.isInstance(object))
				...
				throw new XMFToJavaTypeError("Foreign obj of wrong type", value, type);
		}
		if (Machine.isTable(value)) {
			if (type == java.util.Hashtable.class || type == java.lang.Object.class)
				...
				throw new XMFToJavaTypeError("Table cannot be converted", value, type);
		}
