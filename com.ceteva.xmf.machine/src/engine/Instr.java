 ...
 *             ------------------------------------------------               *
 *                                                                            *
 *  The machine instructions are tagged words. The tag indicates the          *
 *  instruction and the data part of the word contains the operands of the    *
 *  instruction if it has any. This file defines the instruction tags and     *
 *  provides a brief specification of each machine instruction.               *
 *                                                                            *
 ******************************************************************************/
...
public interface Instr {
    ...
    public static final int LOCALNAME    = 107; // Sets the name of a local.

    public static final int UNSETLOCAL   = 108; // The local goes out of scope.

    public static final int LINE         = 109; // Set the line position.
    
    public static final int MKARRAY      = 110; // Make an array of the supplied length.
    
    public static final int HASSLOT      = 111; // Check whether an element has a slot.
