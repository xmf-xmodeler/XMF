 ...
 *             ------------------------------------------------               *
 *                                                                            *
 *  The VM implements a tagged architecture. All values are machine words     *
 *  consisting of a tag and a value. The tag is an 8-bit value that determines*
 *  the type of the value. This file defines the type tags and the associated *
 *  constants.                                                                *
 *                                                                            *
 ******************************************************************************/
